...
internal class DllImportsNativeLibWhisper : INativeWhisper
{
    ...
    [DllImport(NativeConstants.LibWhisperLibraryName, CallingConvention = CallingConvention.Cdecl)]
    private static extern IntPtr whisper_init_from_file_with_params(IntPtr path, WhisperContextParams whisperContextParams);
    ...
    [DllImport(NativeConstants.LibWhisperLibraryName, CallingConvention = CallingConvention.Cdecl)]
    private static extern int whisper_full(IntPtr context, WhisperFullParams parameters, IntPtr samples, int nSamples);
